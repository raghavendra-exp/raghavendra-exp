...
<!-- Typing Animation -->
<a href="https://git.io/typing-svg"><img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=22&pause=1000&color=38BDF8&center=true&vCenter=true&width=700&lines=IAF+Veteran+%7C+HR+Technologist+%7C+Data+Programmer;17%2B+Years+of+Discipline+%2B+Innovation;Oracle+SQL+%7C+PL%2FSql+%7C+Python+Learner;Currently+Pursuing+MBA+(Data+Science);Building+Smarter+Systems+for+a+Better+World+%F0%9F%8C%8D" alt="Typing SVG" /></a>

<br/>

<!-- Badges -->
[![IAF Veteran](https://img.shields.io/badge/IAF-17%2B%20Years%20Service-1d4ed8?style=for-the-badge&logo=airplayaudio&logoColor=white)](https://indianairforce.nic.in/)
[![MCA](https://img.shields.io/badge/MCA-Sikkim%20Manipal%20University-7c3aed?style=for-the-badge&logo=graduation-cap&logoColor=white)]()
[![MBA DS](https://img.shields.io/badge/MBA-Data%20Science%20(Pursuing)-0891b2?style=for-the-badge&logo=databricks&logoColor=white)]()
[![Awards](https://img.shields.io/badge/🏆%20Awards-3%20Military%20Commendations-d97706?style=for-the-badge)]()
...
## ⚡ Career Timeline — From Runways to Runtimes
...
2021  ──●── Commendation by Chief of Command 🏅 · MCA Completed ✅
2021  ──●── New Delhi · Transfer Management (Pan-IAF HRM Systems)
2023  ──●── Commander's Appreciation Award 🏅
2024  ──●── Switched to IAF Programmer Role · Automating Transfer Mgmt Business Models
Now   ──●── Pursuing MBA (Data Science) · Learning AI, ML & Full Stack 🚀
```
...
Designed a quarterly, **trigger-based automated system** that identifies eligible personnel, opens choice windows on scheduled dates, collects preferences — all without a single manual touchpoint.
...
Built a longitudinal **service record repository** for every IAF personnel — enabling future analytics, planning, and policy decisions backed by clean historical data.

---

### 🎓 Online Learning Platform (MCA Final Project)
> **Stack:** PHP · JavaScript · XAMPP

Developed a full-featured e-learning platform for academic submission — laying the foundation for a future in full-stack development.
...
```
🔍  Deep problem analysis before solution design
📊  Strong grip on data reusability & business modeling
🛡️  Rigorous testing mindset — minimal production bugs
⚙️  Automation-first thinking — reducing human error to zero
🗓️  Policy-aware engineering — tech decisions grounded in compliance
```
...
[![GitHub](https://img.shields.io/badge/GitHub-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/raghavendra-exp/raghavendra-exp)
